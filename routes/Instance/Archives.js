...
router.get("/instance/:id/archives", async (req, res) => {
    ...
    try {
        ...
        if (instance.Node && instance.Node.address && instance.Node.port) {
            const RequestData = {
                method: 'get',
                url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.InstanceId}/archives`,
                auth: {
                    username: 'Skyport',
...
router.post('/instance/:id/archives/create', async (req, res) => {
    ...
    const RequestData = {
        method: 'post',
       // url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.InstanceId}/archives`,
        url: `http://Skyport:${instance.Node.apiKey}@${instance.Node.address}:${instance.Node.port}/archive/${instance.InstanceId}/archives/${instance.VolumeId}/create`,
        headers: { 
            'Content-Type': 'application/json'
        }
    };
...
router.post('/instance/:id/archives/delete/:archivename', async (req, res) => {
    ...
    const RequestData = {
        method: 'post',
       // url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.InstanceId}/archives`,
        url: `http://Skyport:${instance.Node.apiKey}@${instance.Node.address}:${instance.Node.port}/archive/${instance.InstanceId}/archives/delete/${archivename}`,
        headers: { 
            'Content-Type': 'application/json'
        }
    };
...
router.post('/instance/:id/archives/rollback/:archivename', async (req, res) => {
    ...
    const RequestData = {
        method: 'post',
       // url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.InstanceId}/archives`,
        url: `http://Skyport:${instance.Node.apiKey}@${instance.Node.address}:${instance.Node.port}/archive/${instance.InstanceId}/archives/rollback/${instance.VolumeId}/${archivename}`,
        headers: { 
            'Content-Type': 'application/json'
        }
    };
